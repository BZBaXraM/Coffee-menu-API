// One-time migration: upload every local dish photo (/uploads/*.png) to the
// Cloudinary "coffee" folder and rewrite the dishes.image column to the hosted
// HTTPS URL, so the frontend loads photos from Cloudinary instead of disk.
//
